  ...
  return (
    <section id="faq" className="border-t border-border/70 bg-background py-20 md:py-28 lg:py-32">
      <SectionWrapper as="div" reveal="up" className="grid gap-12 lg:grid-cols-[0.72fr_1.28fr] lg:gap-24">
        <div>
          <p className="text-[11px] font-semibold uppercase tracking-[0.32em] text-primary">Frequently asked</p>
          <h2 className="mt-5 font-serif text-4xl font-medium uppercase leading-[1.1] tracking-[0.08em] text-foreground md:text-5xl">
